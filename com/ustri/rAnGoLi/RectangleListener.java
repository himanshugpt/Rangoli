...
public class RectangleListener implements ActionListener, MouseMotionListener, MouseListener,ComponentListener {

mainClass Main=null;
	
	public RectangleListener (mainClass mc) {
		Main=mc;
	...
	{	int ht,wt,r,g,b;
		...
		if(isrel == false){
			...
			if((x1>x2)&&(y1>y2)){
				...
				gd.drawRect(x2,y2,ht,wt);

			}
			else if(((x2>x1)&&(y2>y1)))
			{	gd.setXORMode(Color.red);
				
				gd.drawRect(x1,y1,ht,wt);
				
			}
			else if(((x2>x1)&&(y1>y2)))
					{gd.setXORMode(Color.red);
				
						gd.drawRect(x1,y2,ht,wt);
						
					}
			else if(((x1>x2)&&(y2>y1)))
					{gd.setXORMode(Color.red);
				
						gd.drawRect(x2,y1,ht,wt);
			...
			if((tempx1>tempx2)&&(tempy1>tempy2)){
				...
				gd.setXORMode(Color.red);
				gd.drawRect(tempx2,tempy2,ht,wt);
			...
			{
				gd.setXORMode(Color.red);
				gd.drawRect(tempx1,tempy1,ht,wt);
					...
					{
				gd.setXORMode(Color.red);
						gd.drawRect(tempx1,tempy2,ht,wt);
				...
				gd.setXORMode(Color.red);
						gd.drawRect(tempx2,tempy1,ht,wt);
			...
			tempy2=y2;
				...
				if((x1>x2)&&(y1>y2)){
					...
					gd.drawRect(x2,y2,ht,wt);
					Main.arr.get(Index).gc.drawRect(x2,y2,ht,wt);
				...
				Main.arr.get(Index).gc.setColor(Main.g.getColor());
					...
					gd.drawRect(x1,y1,ht,wt);
					Main.arr.get(Index).gc.drawRect(x1,y1,ht,wt);
						...
						Main.arr.get(Index).gc.setColor(Main.g.getColor());
							...
							gd.drawRect(x1,y2,ht,wt);
							Main.arr.get(Index).gc.drawRect(x1,y2,ht,wt);
						...
						Main.arr.get(Index).gc.setColor(Main.g.getColor());
							...
							gd.drawRect(x2,y1,ht,wt);
							Main.arr.get(Index).gc.drawRect(x2,y1,ht,wt);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (Index >=0){
			...
			Main.rectangle.setSelected(false);
		}
	}
