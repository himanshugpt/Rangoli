...
public class CircleClass implements ActionListener, MouseMotionListener, MouseListener,ComponentListener {
 ...
 JOptionPane jp;
	...
	public CircleClass (mainClass mc) {
		Main=mc;
	...
	{	int ht,wt,r,g,b;
		...
		if(isrel == false){
			...
			if((tempx1>tempx2)&&(tempy1>tempy2)){
				...
				gd.setXORMode(Color.red);
				gd.drawOval(tempx2,tempy2,ht,wt);
			...
			{
				gd.setXORMode(Color.red);
				gd.drawOval(tempx1,tempy1,ht,wt);
					...
					{
				gd.setXORMode(Color.red);
						gd.drawOval(tempx1,tempy2,ht,wt);
				...
				gd.setXORMode(Color.red);
						gd.drawOval(tempx2,tempy1,ht,wt);
